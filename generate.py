...
CHECKPOINT_FOLDER = "checkpoints/ckpt_nolinebyline_stop3" # "ckpt_bs16_gpu4" # "ckpt_testing" # "ckpt_nolinebyline_stop3"
...
story = story_generator(input_prompt, max_length=1000, do_sample=True,
